 ...
 * Authors: Minh-Tri Duong, Marzia Grasso, Angelo Quaglia, Massimo Craglia
LICENSE END***/
...
import eu.europa.ec.jrc.euosme.gwt.client.ISOInfoButton;
 ...
 */
public class ISOCharacterString extends Composite {
	
	private static ISOCharacterStringUiBinder uiBinder = GWT.create(ISOCharacterStringUiBinder.class);
	interface ISOCharacterStringUiBinder extends UiBinder<Widget, ISOCharacterString> {	}
	...
	@UiField
	ISOInfoButton infoButton = new ISOInfoButton();
	...
	/** 
     * constructor ISOCharacterString: 0..1 (String)
     * 
     ...
     */
	public ISOCharacterString(String label, String help, boolean required, CheckFunctions check, boolean autoupdatetree) {
